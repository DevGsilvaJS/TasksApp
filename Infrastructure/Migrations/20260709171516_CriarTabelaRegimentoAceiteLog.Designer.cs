...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260709171516_CriarTabelaRegimentoAceiteLog")]
    partial class CriarTabelaRegimentoAceiteLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.EmailEnvioComercial", b =>
                {
                    b.Property<int>("EecId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("EECID");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("EecId"));

                    b.Property<DateTime>("EecDataCadastro")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("EECDATACADASTRO");

                    b.Property<string>("EecEmail")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)")
                        .HasColumnName("EECEMAIL");

                    b.Property<bool>("EecNaoEnviar")
                        .HasColumnType("boolean")
                        .HasColumnName("EECNAOENVIAR");
                    ...
                    b.ToTable("TB_EMAIL_ENVIO_COMERCIAL");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Regimento", b =>
                {
                    ...
                    b.Property<string>("RegDescricao")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("REGDESCRICAO");

                    b.Property<int>("RegStatus")
                        .HasColumnType("integer")
                        .HasColumnName("REGSTATUS");

                    b.Property<string>("RegTitulo")
                        .IsRequired()
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)")
                        .HasColumnName("REGTITULO");

                    b.HasKey("RegId");

                    b.ToTable("TB_REG_REGIMENTO");
                });

            modelBuilder.Entity("Domain.Entities.RegimentoAceite", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("RacId"));

                    b.Property<int>("RacAceito")
                        .HasColumnType("integer")
                        .HasColumnName("RACACEITO");

                    b.Property<DateTime?>("RacDataAceite")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("RACDATAACEITE");

                    b.Property<string>("RacObservacao")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)")
                        .HasColumnName("RACOBSERVACAO");
